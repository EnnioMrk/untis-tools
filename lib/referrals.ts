...
export async function generateUniqueReferralCode(prefix: string = 'REF'): Promise<string> {
...
export async function grantReferralRewardForSubscriber(userId: string): Promise<void> {
