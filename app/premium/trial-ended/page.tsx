        ...
        <section className="rounded-3xl border border-amber-500/30 bg-amber-500/10 p-8 shadow-2xl">
          <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
            <div className="max-w-3xl">
              ...
              <h1 className="text-4xl font-bold">Your free Premium month has ended</h1>
              <p className="mt-3 text-lg text-slate-300">
                To continue using UntisStats, choose a subscription. All plans are paid subscriptions,
        ...
        <section className="grid gap-6 md:grid-cols-3">
          {plans.map((plan) => (
            ...
            >
              ...
              <div className="mb-6">
                <span className="text-4xl font-bold">{plan.monthlyPriceLabel}</span>
                <span className="ml-1 text-slate-300">/month</span>
              </div>
